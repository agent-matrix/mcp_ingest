...
def score_entry(*, repo_metrics: Dict[str, Any] | None, detect_report: Dict[str, Any] | None, validation: Dict[str, Any] | None) -> float:
    ...
    if repo_metrics:
        ...
        if repo_metrics.get("license"): score += 0.02
        if repo_metrics.get("recent"): score += 0.03
